...
# В backend/app/main.py обновите CORS middleware:
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://ваш-frontend.twc1.net",  # Добавьте ваш Timeweb frontend URL
        "https://*.twc1.net",              # Или разрешите все Timeweb домены
        "http://localhost:3000",
        "http://localhost:3001"
    ],
