    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mt-6 bg-blue-50 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-blue-800 mb-3">📊 Статистика розыгрыша</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div>
              <p className="text-2xl font-bold text-blue-600">{raffle.participants_count}</p>
              <p className="text-sm text-gray-600">Участников</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-blue-600">{raffle.winners.length}</p>
              <p className="text-sm text-gray-600">Победителей</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-blue-600">
                {Math.round((raffle.winners.length / raffle.participants_count) * 100)}%
              </p>
              <p className="text-sm text-gray-600">Шанс победы</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-blue-600">
