      ...
      <PageBackground page="live">
        <div className="min-h-screen p-4">
          <div className="container mx-auto text-center">
            <p className="text-white">Розыгрыш не найден</p>
            <button
              onClick={() => navigate('/')}
        ...
        <div className="container mx-auto p-4">
          ...
          {countdown !== null && countdown > 0 && (
            <div className="text-center mb-8 animate-pulse">
              <p className="text-2xl mb-2 text-white">🎰 Розыгрыш начнется через:</p>
              <p className="text-6xl font-bold text-white">{formatCountdown(countdown)}</p>
            </div>
          )}
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur rounded-lg p-6">
              <h2 className="text-2xl font-semibold mb-4 text-white">🏆 Призовые места</h2>
                ...
                {Object.entries(raffle.prizes)
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-sm text-white opacity-90">{prize}</div>
                      {winner && (
                      ...
                      {isCurrentRound && !winner && (
                        <div className="text-sm mt-2 animate-pulse text-white">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
              {participants.map((participant) => {
                ...
                return (
                  <div 
                    key={participant.id} 
                    className={`rounded-lg px-3 py-2 text-sm transition-all text-white ${
          ...
          {connectionStatus === 'completed' && (
            <div className="mt-8 text-center">
              <div className="bg-white/20 backdrop-blur rounded-lg p-8">
                <h2 className="text-3xl font-bold mb-4 text-white">🎊 Розыгрыш завершен!</h2>
                <p className="text-xl mb-4 text-white">Поздравляем всех победителей!</p>
                <button
                  onClick={() => navigate('/')}
